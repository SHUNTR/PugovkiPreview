let ChangeStats=function(){$(".stats__number-wrapper").each(function(e,t){let a=t.textContent.trim().split("").reverse();var i=[];for(let e=0;e<Math.ceil(a.length/3);e++)i[e]=a.slice(3*e,3*e+3).reverse().join("");a=i,$(this).empty();for(let e=a.length-1;0<=e;e--)$(this).append(`<span class='stats__number'>${a[e]}</span>`)})};ChangeStats();const swiper=new Swiper(".main-swiper",{slidesPerView:"auto",centeredSlides:!0,grabCursor:!0,spaceBetween:30,pagination:{clickable:!0,el:".swiper-pagination"},navigation:{nextEl:".swiper__button-next",prevEl:".swiper__button-prev"},autoplay:{delay:3e3}}),CategorySwiper=new Swiper(".category-swiper",{lazy:!0,grabCursor:!0,slidesPerView:"7",slidesPerGroup:7,navigation:{nextEl:".swiper__button-next",prevEl:".swiper__button-prev"},breakpoints:{1600:{slidesPerView:"6",slidesPerGroup:6},1366:{slidesPerView:"5",slidesPerGroup:5},980:{slidesPerView:"4",slidesPerGroup:4},768:{slidesPerView:"3",slidesPerGroup:3},0:{slidesPerView:"2",slidesPerGroup:2}},spaceBetween:20}),ItemsSwiper=new Swiper(".items-swiper",{lazy:!0,grabCursor:!0,spaceBetween:20,slidesPerView:"7",slidesPerGroup:7,navigation:{nextEl:".swiper__button-next",prevEl:".swiper__button-prev"},breakpoints:{1920:{slidesPerView:"6",slidesPerGroup:6},1366:{slidesPerView:"5",slidesPerGroup:5},980:{slidesPerView:"4",slidesPerGroup:4},768:{slidesPerView:"3",slidesPerGroup:3},0:{slidesPerView:"2",slidesPerGroup:2}}});function ChangeCountNotfication(e,t){$(`button[data-type-menu='${e}']`).find(".notification-count").each(function(){let e=Number(this.textContent);switch(t){case"plus":e++;break;case"minus":e--}99<(e=0==e?"":e)&&(e="99+"),this.textContent=e})}function CreateObjectItem(e){var t={id:e.attr("data-id-item").trim(),type:e.attr("data-item-type"),favorite:e.attr("data-favorite"),name:[e.find(".item__name").text().trim(),e.find(".item__name").attr("date-decoration")],like_count:e.find(".item__likes").text().trim(),views_count:e.find(".item__views").text().trim(),img:e.find(".item__img").attr("src"),user:{id:e.find(".item__user").attr("data-id-user"),name:e.find(".item__user-name").text().trim(),img:e.find(".item__avatar").attr("src")}};switch(0!=e.find(".item__user-status").length?t.user.status="PRO":t.user.status="default",t.type){case"action":t.actionType=e.attr("data-type-action"),t.dateTime=e.find(".item__date-time").text().trim(),t.BetStatus=e.find(".item__price-status").attr("data-status"),t.BetCount=e.find(".item__price").text().trim();break;case"onsell":t.price=e.find(".item__price").text().trim(),e.find(".discount")?t.discount=e.find(".discount").text().trim():t.discount="0"}return t}function CreateDOMItem(i){if("action"==i.type){let e,t="",a;return a="start"==i.BetStatus?(e="Начальная ставка",'<i class="fa-solid fa-caret-right"></i>'):(e="Текущая ставка",'<i class="fa-solid fa-sort-up"></i>'),"PRO"==i.user.status&&(t='<img src="assets/images/main/pro.svg" alt="" class="item__user-status"></img>'),`
    <div class="item" data-favorite="${i.favorite}"" data-id-item="${i.id}" data-item-type="action" data-type-action="${i.actionType}">
        ...
        </div>`}if("onsell"==i.type){let e="";return"PRO"==i.user.status&&(e='<img src="assets/images/main/pro.svg" alt="" class="item__user-status"></img>'),`
    <div class="item" data-favorite="${i.favorite}"" data-id-item="${i.id}" data-item-type="onsell">
        <a class="item__img-wrapper" href="">
            <img src="${i.img}" alt="" class="item__img">
        </a>
        <button class="favorite-btn" type="button" onclick='DeleteFavorite(event)'>           
            ...
            <div class="item__element">
               ...
               <img src="assets/images/main/heart-icon__filled.svg" alt="" class="moved-menu__img">`)))}),$(".moved-aside__btn").on("click",function(){$(this).hasClass("active")?$(".moved-aside__btn.active").removeClass("active"):($(".moved-aside__btn.active").removeClass("active"),$(this).addClass("active"))}),$(".notification__btn").on("click",function(){var e=$(this).attr("data-action");if("close"===e)try{$(this).parents(".notification").slideUp(300,function(){$(this).remove()})}catch(e){}}),$(".search__btn").on("click",function(){$(this).parents(".search").hasClass("active")?$(this).parents(".search").removeClass("active"):$(this).parents(".search").addClass("active")}),$(".popup-opener").on("click",function(){$(this).siblings(".popup").hasClass("active")?$(this).siblings(".popup").fadeOut(100).removeClass("active"):($(".popup.active").removeClass("active").fadeOut(100).removeClass("active"),$(this).siblings(".popup").fadeIn(100).addClass("active"))}),$(".select-opener").on("click",function(){var e=$(this).siblings(".select__body");if(e.hasClass("active"))e.removeClass("active");else{try{$(".select__body.active").removeClass("active")}catch{}e.addClass("active")}}),$(".moved-menu-opener").on("click",function(){var e=$(this).attr("data-type-menu");try{$(`.moved-menu[data-type-menu='${e}']`).hasClass("active")?($(`.moved-menu[data-type-menu='${e}']`).removeClass("active"),$(this).removeClass("active")):($(".moved-menu.active").removeClass("active"),$(".submenu.active").removeClass("active"),$(`.moved-menu[data-type-menu='${e}']`).addClass("active"),$(this).addClass("active"),$("body").addClass("scrollBlock"))}catch(e){}}),$(".submenu-opener").on("click",function(){$(this).siblings(".submenu").addClass("active")}),$(".submenu__btn").on("click",function(){var e=$(this).attr("data-action"),t=$(this).parents(".submenu");if("close"===e)try{t.removeClass("active")}catch(e){console.log("Произошла ошибка")}}),$(".moved-menu__btn").on("click",function(){var e=$(this).attr("data-action"),t=$(this).parents(".moved-menu"),a=$(".moved-menu.active").attr("data-type-menu");switch(e){case"close":try{t.removeClass("active"),$(`button[data-type-menu='${a}']`).removeClass("active"),$("body").removeClass("scrollBlock")}catch(e){}break;case"AddBurse":try{t.removeClass("active"),$(`button[data-type-menu='${a}']`).removeClass("active"),$("body").removeClass("scrollBlock"),alert("Ваша заявка находится на расмотрении")}catch(e){}}}),$(".select__btn").on("click",function(){var e=$(this).text().trim();$(this).parents(".select__body").siblings(".select-opener").find(".select__text").html(e),$(".select__body.active").removeClass("active")}),$(".filter__checkbox").on("change",function(){var e=$(this).parents(".filter__block").find(".filter__title .filter__count"),t=$(".catalog__count");$(this).is(":checked")?(e.text(Number(e.text().trim())+1),t.text(Number(t.text().trim())+1)):(e.text(Number(e.text().trim())-1),t.text(Number(t.text().trim())-1),Number(e.text().trim())<1&&e.text(""),Number(t.text().trim())<1&&t.text(""))}),$(".filter__btn").on("click",function(){switch($(this).attr("data-action")){case"accept":$(".catalog__filter-wrapper").empty(),$(".filter__checkbox:checked").each(function(){var e=$(this).siblings(".filter__label");switch(e.attr("data-filter-type")){case"color":var t={id:e.attr("data-id-color"),index:e.attr("data-color-index"),name:e.attr("data-name-color")};$(".catalog__filter-wrapper").append(` 
                            ...
                            <button class="catalog__btn" data-action="removefilter">
                                ...
                                <i class="fa-solid fa-xmark"></i>
                            </button>`)}}),$(this).parents(".moved-menu").removeClass("active");break;case"reset":$(".filter__checkbox:checked").prop("checked",!1),$(".filter__count").empty(),$(".catalog__count").empty(),$(".catalog__filter-wrapper").empty(),$(this).parents(".moved-menu").removeClass("active")}});{var e=$(".moved-menu__count_orange");let a=0;var t=$('span[data-notification="all"]');e.each(function(e,t){t=Number(t.textContent.trim().replace("+","")),a+=t}),99<a&&(a="99+"),t.html(""+a)}$(".switcher__btn").on("click",function(){$(this).toggleClass("active"),$(this).parents(".switcher").toggleClass("active")}),$("body").on("click",'.catalog__btn[data-action="removefilter"]',function(){$(this).slideUp(300,function(){$(this).remove()})})}),$(".filter__range").slider({animate:"fast",range:!0,values:[100,19300],max:19300,min:100,slide:function(e,t){var a=$(this).parents(".filter__range-wrapper").siblings(".filter__input-wrapper").find(".filter__input");a[0].value=t.values[0],a[1].value=t.values[1]}});export{ChangeStats};